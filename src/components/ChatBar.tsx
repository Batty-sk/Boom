...
<div className='w-[100%] h-[100%] bg-slate-200 border  relative'>
   <div className='font-mono  flex justify-around items-center text-center text-3xl p-5 text-black font-extrabold border relative z-10' style={{background:'lightblue'}}>  
